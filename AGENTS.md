...
- The recurrent PPO mathematical core, ordered compound replay, GAE, recurrent slicing, restricted checkpoint recovery, toy tasks and bounded G3a cloud qualification are complete. CABT actor/learner integration, G3b competence training, league training, deck bakeoff, champion selection and learned submission packaging remain incomplete. G3a correctness does not authorize G3b training or establish policy strength.
