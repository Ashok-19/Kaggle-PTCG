...
WRAPPER = Path(__file__).with_name("e01_recurrent_bc_smoke_notebook.py")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Build Kaggle source for the E01 recurrent-BC smoke train.")
    ...
    source = (
        ...
        "import sys\n"
        "import zlib\n"
        "bootstrap = pathlib.Path('/kaggle/working/e01-recurrent-bc-smoke-bootstrap-v1')\n"
        "bootstrap.mkdir(parents=True, exist_ok=False)\n"
        "wrapper = bootstrap / 'e01_recurrent_bc_smoke_notebook.py'\n"
