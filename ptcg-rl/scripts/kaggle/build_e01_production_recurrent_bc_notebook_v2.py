...
WRAPPER = Path(__file__).with_name("e01_production_recurrent_bc_notebook_v2.py")
...
def main() -> None:
    ...
    source = (
        ...
        "import subprocess\n"
        "import sys\n"
        "bootstrap = pathlib.Path(\"/kaggle/working/e01-production-recurrent-bc-bootstrap-v2\")\n"
        "bootstrap.mkdir(parents=True, exist_ok=False)\n"
        "wrapper = bootstrap / \"e01_production_recurrent_bc_notebook_v2.py\"\n"
        "approval = bootstrap / \"e01-production-recurrent-bc-approval-v2.json\"\n"
