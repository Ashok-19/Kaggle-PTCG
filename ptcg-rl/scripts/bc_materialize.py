...
def _materialize_one(episode_id: int) -> dict[str, Any]:
    ...
    return {
        ...
        "teacher_score_qualification_value": record.get("teacher_score_qualification_value"),
        "teacher_quality_tier": record.get("teacher_quality_tier"),
        "teacher_sample_weight": record.get("teacher_sample_weight"),
