...
ENTITY_FEATURE_NAMES = (
    "card_id", "owner", "zone", "position", "hp", "max_hp", "damage",
    "appear_this_turn", "attached_energy_count", "attached_tool_count", "evolution_depth",
)
OPTION_FEATURE_NAMES = (
    ...
    "attack_id", "card_id", "special_condition_type", "source_entity_index", "target_entity_index",
)
EVENT_FEATURE_NAMES = ("event_type", "player_index", "card_id", "value", "count", "result")
...
class SelectionRequestV1:
    ...
    def __post_init__(self) -> None:
        ...
        if self.max_count > len(self.options):
            raise ContractViolation("max_count exceeds legal option count")
...
class SubSelectionV1:
    ...
    chosen_model_index: int
    chosen_semantic_fingerprint: str
    original_index: int
