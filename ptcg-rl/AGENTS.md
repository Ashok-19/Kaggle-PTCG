...
Maximize the probability of a top-20/gold finish in the 2026 Pokemon TCG AI Battle competition. Work one evidence-gated milestone at a time.
...
- Read `PROJECT_STATUS.md` and the relevant design document before editing.
